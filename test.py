...
def pc100():
    TARGET_IP_ADDR = input("target ip:")
    MY_IP_ADDR = '172.29.184.116'#input("my ip:")
    NODE_IP_ADDR = '172.20.144.128'#input("node ip:")
    A_B = queue.Queue()
    B_A = queue.Queue()
    
    #addr1 = input("node(1) ip address: ")
    addr1 = "172.20.144.128"
    #proto1 = input("node(1) protocol(icmp/tcp): ").upper()
    proto1 = "ICMP"
    node1 = Node_Connection(addr1,proto1,A_B,B_A)
    #addr2 = input("node(2) ip address: ")
